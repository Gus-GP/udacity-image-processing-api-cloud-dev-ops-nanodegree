...
import {filterImageFromURL, deleteLocalFiles, isValidUrl} from './util/util.js';
  ...
  app.get( "/filteredimage", async ( req, res ) => {
    ...
    try {
      ...
      }).catch(() => res.status(500).send("Hello! Something went wrong processing your image! Have a nice day!"));
      ...
      }).catch(() => res.status(500).send("Hello! Something went wrong deleting your image! Have a nice day!"));;
